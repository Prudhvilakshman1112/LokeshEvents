...
export const catalogItems: CatalogItem[] = [
  ...
  },
  {
    ...
    category: "Surprise",
    description: "An upgraded version of our classic surprise package with personalized gifts. Includes one teddy doll, custom photo frame, calendar, and printed mug alongside cake and fire gun celebrations on the scenic Vizag Beach Road.",
    image: "/images/doll-surprise-upgraded.png",
    images: ["/images/doll-surprise-upgraded.png"],
    liveImages: [], liveVideos: [],
    itemsIncluded: ["1 Teddy Doll", "Half KG Cake (Cool/Gold)", "A4 Size Photo Frame", "Calendar", "Printed Mug", "2 Fire Guns"],
  ...
  },
  {
    ...
    liveImages: [], liveVideos: ["/videos/VID-20260428-WA0121.mp4", "/videos/VID-20260428-WA0122.mp4", "/videos/candlelight-dinner-clip3.mp4"],
